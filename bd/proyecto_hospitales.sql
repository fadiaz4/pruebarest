...
CREATE TABLE `hospitales` (
  ...
  `hospitalescol` varchar(45) DEFAULT NULL,
  `nombrehosp` varchar(45) DEFAULT NULL,
  `direccionhosp` varchar(45) DEFAULT NULL,
  `telefonohosp` varchar(45) DEFAULT NULL,
  `especialidadeshosp` varchar(45) DEFAULT NULL,
